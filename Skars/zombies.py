...
from SƈαɾLσɾԃ import telethn as SƈαɾLσɾԃTelethonClient
from Database.clear_cmd_sql import get_clearcmd
from telethn.chatstatus import user_is_admin
from Bytes.misc import delete


@SƈαɾLσɾԃTelethonClient.on(events.NewMessage(pattern=f"^[!/]zombies ?(.*)"))
