...
import Database.welcome_sql as sql
import SƈαɾLσɾԃ
...
from Bytes.misc import build_keyboard, delete, revert_buttons
from Bytes.msg_types import get_welcome_type
...
def new_member(update: Update, context: CallbackContext):
    ...
    for new_mem in new_members:
        ...
        if new_mem.id == bot.id and not SƈαɾLσɾԃ.ALLOW_CHATS:
