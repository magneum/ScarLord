...
from Bytes.string_handling import split_quotes
from Skars.log_channel import loggable
from Database import warns_sql as sql
...
def warn(
    ...
    if num_warns >= limit:
        ...
        # message.bot.send_sticker(chat.id, BAN_STICKER)  # SƈαɾLσɾԃ's sticker
        keyboard = None
        log_reason = (
