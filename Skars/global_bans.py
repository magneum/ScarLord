...
import Database.global_bans_sql as sql
from Database.users_sql import get_user_com_chats
...
from Bytes.misc import send_to_list
        ...
        try:
            ...
            if excp.message in GBAN_ERRORS:
                ...
                if EVENT_LOGS:
                    ...
                    send_to_list(
                        bot, SUDO_USERS,f"Could not gban due to: {excp.message}"
                    )
